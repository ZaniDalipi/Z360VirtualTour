...
// Helper to safely parse images from API response
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (relatedRes.ok) {
            ...
            setRelatedTours(relatedData.filter?.((t: RelatedTour) => t.slug !== slug).slice(0, 3) || [])
          }
        }
      } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-navy">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="text-cream-muted mb-8">{t('notFoundMessage')}</p>
          <Link href="/tours">
          ...
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="hidden sm:inline text-sm">{t('backToTours')}</span>
              </Link>
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 md:pb-16">
            ...
            >
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-cream max-w-3xl">
                {tour.title}
              </h1>
