      ...
      days.push(
        <motion.button
          ...
          className={`
            ...
            ${!isSelected && !isPast && info.hasSchedule && !info.isBlocked ? 'bg-green-500/10 border-green-500/30 hover:border-green-500/50' : ''}
            ${!isSelected && !isPast && !info.hasSchedule && !info.isBlocked ? 'bg-navy-dark/30 border-gold/10 hover:border-gold/30 hover:bg-navy-dark/50' : ''}
          `}
        >
          <span className={`text-sm sm:text-base font-semibold ${isSelected ? 'text-navy' : 'text-cream'}`}>
            {day}
          </span>
          {info.hasSchedule && !info.isBlocked && (
                    ...
                    <Card className="p-6 sticky top-24">
                      ...
                      {selectedDay.isBlocked ? (
                        ...
                        <div className="space-y-4">
                          ...
                          <Link href={`/contact?date=${selectedDay.date.toISOString().split('T')[0]}&cities=${selectedDay.cities.join(',')}`}>
                        ...
                        <div className="space-y-4">
                          ...
                          <Link href={`/contact?date=${selectedDay.date.toISOString().split('T')[0]}`}>
                            <Button className="w-full">
                              Request This Date
                            </Button>
                          </Link>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-cream-muted">
                    ...
                    <ul className="space-y-1">
                      ...
                      <li>• Red dates are unavailable</li>
                      <li>• White dates are fully available</li>
                    </ul>
                  </div>
                </div>
              </Card>
