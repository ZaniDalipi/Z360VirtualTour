        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold/10 border border-gold/20 text-gold mb-6">
              ...
              <span className="text-sm font-medium">Our Schedule</span>
            </div>
            ...
            <p className="text-lg text-cream-muted max-w-2xl mx-auto mb-6">
              Check our availability calendar and book when we are in your area to save on travel costs
            </p>
            ...
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30">
              ...
              <div className="text-left">
                <p className="text-green-400 font-semibold">Save {sameCityDiscountPercent}% on Same-City Bookings</p>
                <p className="text-green-400/70 text-sm">Book when we are already in your area</p>
              </div>
            </div>
          </motion.div>
        </div>
                      ...
                      {selectedDay.isBlocked ? (
                        <div className="space-y-4">
                          ...
                          <p className="text-cream-muted text-sm">
                            Please select another date or contact us to discuss alternatives.
                          </p>
                        </div>
                      ) : (
                        <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                      <div className="flex items-start gap-2 p-2 rounded-lg bg-orange-500/10">
                                        ...
                                        <p className="text-xs text-orange-300">
                                          Bundle is full, but you can request emergency booking at {bundle.discountPercent / 2}% discount instead of {bundle.discountPercent}%.
                                        </p>
                                      </div>
                                      <Link href={`/quote?date=${selectedDay.dateStr}&city=${bundle.city}&bundleId=${bundle.id}`}>
                                ...
                                <div className="flex items-start gap-3">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-cream-muted text-sm mt-1">
                                      Book in {selectedDay.cities.join(' or ')} and save {sameCityDiscountPercent}% on travel
                                    </p>
                                  </div>
                                </div>
                              </div>

                              <Link href={`/quote?date=${selectedDay.dateStr}&cities=${selectedDay.cities.join(',')}`}>
                            ...
                            <>
                              <div className="flex items-center gap-3 p-4 rounded-xl bg-navy border border-gold/20">
                                ...
                                <div>
                                  ...
                                  <p className="text-cream-muted text-sm">We can schedule work on this date</p>
                                </div>
                              </div>

                              <Link href={`/quote?date=${selectedDay.dateStr}`}>
                                <Button className="w-full">
                                  Request This Date
                                </Button>
                              </Link>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-cream-muted">
                    ...
                    <ul className="space-y-1">
                      <li>• Purple dates have group bundles with bigger discounts</li>
                      <li>• Green dates have scheduled work in those areas</li>
                      <li>• Book when we are in your area for {sameCityDiscountPercent}% off travel</li>
                      <li>• Full bundles allow emergency requests at half discount</li>
                    </ul>
                  </div>
                </div>
              </Card>
      ...
      <section className="py-12 md:py-16 bg-navy-dark">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-cream-muted mb-8">
            We are flexible! Get in touch and we'll find a time that works for you.
          </p>
          <Link href="/contact">
